...
class MiniProgramScssFormattingModelBuilder : SCSSFormattingModelBuilder() {

    override fun createExtension(settings: CodeStyleSettings): ScssFormattingExtension {
        return object : SCSSFormattingModelBuilder.ScssFormattingExtension(
                settings.getCommonSettings(SCSSLanguage.INSTANCE),
                settings.getCustomSettings(ScssCodeStyleSettings::class.java)
        ) {
            override fun createPropertyBlock(
                ...
                return if (StyleLanguageUtils.isMiniProgramContext(_node)) {
                    val indent = if (_node.treeParent
                            ...
                            ) != null)) Indent.getNormalIndent() else Indent.getNoneIndent()
