...
class WXMLClassSelectorManipulator :
        MyAbstractElementManipulator<CssClass>({ project, elementText ->
            CssElementFactory.getInstance(
                    project
            ).createSimpleSelector(elementText, WXSSLanguage.INSTANCE).findChildOfType()!!
        })